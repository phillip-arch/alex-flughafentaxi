          ...
          <React.Fragment key={step.key}>
            <button
              ...
              onClick={() => handleStepIndicatorClick(step.key)}
                className={`inline-flex shrink-0 items-center gap-[0.38rem] rounded-full border px-[0.62rem] py-[0.36rem] text-[11px] transition-all md:gap-1 md:px-3 md:py-1.5 md:text-[13px] ${
                isCurrent
            ...
            >
                <Icon size={14} strokeWidth={2.2} className="md:h-4 md:w-4" />
