        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className={`ui-field-surface h-12 w-full rounded-[var(--radius-field)] border px-3 py-0 text-[10px] text-[#1d1d1f] outline-none transition-all cursor-pointer md:h-[2.4rem] md:px-[0.8rem] md:text-[17px] ${
                isFieldInvalid('date')
