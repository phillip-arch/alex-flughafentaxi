...
export default function BookingStepTwo({
  ...
  return (
    <div className="w-full min-w-0 max-w-full overflow-x-clip px-[10px] md:px-0 space-y-8 animate-in fade-in slide-in-from-right-4 duration-500 [@media(min-width:768px)_and_(max-height:850px)]:space-y-4">
