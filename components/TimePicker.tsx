...
export default function TimePicker({ isOpen, onClose, onSelect, selectedTime }: TimePickerProps) {
  ...
  return (
    <div
      ref={containerRef}
      className="absolute right-0 top-full z-40 mt-3 w-[min(9rem,calc(100vw-2rem))] max-w-[calc(100vw-2rem)] rounded-[0.9rem] border border-[#e6e1d7] bg-white p-[0.7rem] shadow-[0_16px_34px_rgba(17,17,17,0.14)] animate-in fade-in slide-in-from-top-2 duration-200 sm:left-0 sm:right-auto sm:w-[9rem] sm:max-w-none"
    >
