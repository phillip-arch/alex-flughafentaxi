            ...
            <div className="ui-card-surface-light px-6 py-8 md:px-8 md:py-10">
              <div className="mx-auto flex max-w-[42rem] flex-col items-center text-center">
                ...
                <div className="mt-8 flex w-full flex-col gap-3 sm:flex-row sm:justify-center">
                  ...
                  >
                    <span className="text-[var(--night)]">Book another ride</span>
                    <ArrowRight size={17} className="text-[var(--night)]" />
                  </Link>
                  <Link
                    href={returnHomeHref}
                    className="inline-flex items-center justify-center rounded-[var(--radius-field)] border border-[var(--line)] bg-[var(--night)] px-7 py-4 text-[1.0625rem] font-medium leading-none text-[var(--amber)] shadow-[0_10px_24px_rgba(17,17,17,0.04)] transition-colors hover:bg-[rgba(255,255,255,.06)] hover:text-[var(--amber)]"
                  >
