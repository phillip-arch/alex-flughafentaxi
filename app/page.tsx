    ...
    <div className="servus-home-reference min-h-screen bg-[#0A111F] text-[#F4F1E8]">
      ...
      <main>
        ...
        <section id="hero" className="relative overflow-hidden bg-[#070d18] text-[#F4F1E8]">
          <div className="mx-auto grid w-full max-w-[1780px] gap-10 px-5 pb-14 pt-[94px] sm:px-8 lg:pt-[108px] min-[1180px]:grid-cols-[minmax(0,0.92fr)_minmax(390px,500px)] min-[1180px]:items-start min-[1180px]:justify-between min-[1180px]:gap-8 min-[1180px]:px-8 min-[1180px]:pb-16 min-[1180px]:pt-[118px] min-[1536px]:grid-cols-[minmax(0,0.9fr)_minmax(410px,540px)] min-[1536px]:gap-10 min-[1536px]:px-12 min-[1536px]:pt-[132px] min-[1900px]:min-h-[1040px] min-[1900px]:grid-cols-[minmax(0,760px)_640px] min-[1900px]:gap-14 min-[1900px]:px-[82px] min-[1900px]:pt-[166px]">
